...
set INCLUDE_CUSTOM_DIR   $env(DIR_INCLUDE_CUSTOM)
...
if {[llength [glob -nocomplain [file join $INCLUDE_CUSTOM_DIR *.vh]]] != 0} {
  read_verilog [glob [file join $INCLUDE_CUSTOM_DIR *.vh]]
}
